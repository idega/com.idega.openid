...
public class OpenIDConstants {
	...
	public static final String ATTRIBUTE_PERSONAL_ID = "http://www.elykill.is/contact/personalID";
	public static final String ATTRIBUTE_PERSONAL_ID_ALIAS = "personalID";
